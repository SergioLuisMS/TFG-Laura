...
<div class="pantalla-estudio" 
    ...
    <div class="capa-mapa" style="position: relative; display: inline-block;">
        ...
        @if($tipo === 'botica')
            ...
            {{-- Elementos de Botica (Botes y Reacciones) --}}
            ...
            <div id="reacciones-contenedor">
                <img src="{{ asset('img/items/botica/caldero/caldero1.png') }}" id="reaccion-bote1" class="reaccion-caldero" style="display:none;">
                <img src="{{ asset('img/items/botica/caldero/caldero2.png') }}" id="reaccion-bote2" class="reaccion-caldero" style="display:none;">
                <img src="{{ asset('img/items/botica/caldero/caldero3.png') }}" id="reaccion-bote3" class="reaccion-caldero" style="display:none;">
                <img src="{{ asset('img/items/botica/caldero/caldero4.png') }}" id="reaccion-bote8" class="reaccion-caldero" style="display:none;">
            </div>
            ...
            <map name="image-map">
                <area alt="cajon" coords="943,513,942,608,1019,629,1029,533" shape="poly" href="javascript:void(0);" id="area-cajon">
    ...
    <div class="contenido-sala-minimal">
        ...
        <div class="botones-inferiores">
            <a href="{{ route('perfil') }}" id="btn-terminar-sesion" class="btn-estudio btn-finalizar">TERMINAR</a>
